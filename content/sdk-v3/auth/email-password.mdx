...
<Callout type="warning">
  `signUp` requires a [custom domain](/docs-v2/custom-domains) connected to the paywall — the confirmation-email link is built from it. Without one the backend rejects the call with [`custom_domain_required`](/docs-v2/sdk-v3/errors#configuration-and-initialization) (no half-created account, no broken email). [Email OTP](/docs-v2/sdk-v3/auth/otp) works without a custom domain.
</Callout>
