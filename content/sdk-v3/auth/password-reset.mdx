...
<Callout type="warning">
  `requestPasswordReset` requires a [custom domain](/docs-v2/custom-domains) connected to the paywall — the recovery-email link is built from it. Without one the backend rejects the call with [`custom_domain_required`](/docs-v2/sdk-v3/errors#configuration-and-initialization).
</Callout>
