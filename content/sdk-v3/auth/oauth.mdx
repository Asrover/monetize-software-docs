...
<Callout type="warning">
  OAuth requires a [custom domain](/docs-v2/custom-domains) connected to the paywall — the popup's callback page lives on it. Without one the backend rejects the init call with [`custom_domain_required`](/docs-v2/sdk-v3/errors#configuration-and-initialization) and the popup never opens. This applies to extensions too.
</Callout>
