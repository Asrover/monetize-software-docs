...
2. **At least one payment processor is connected.** For testing you don't need an account of your own — connect one of our [sandbox processors](/docs-v2/payment-processor/sandbox-processors) from the Test tab. For live payments, connect your own (Stripe / Paddle / Chargebee / Freemius).
...
<Cards>
  ...
  <Cards.Card
    ...
    description="apiKey, per-user Bearer, token credit/debit, webhooks"
  />
</Cards>
