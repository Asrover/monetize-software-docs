...
End-to-end guide for adding a subscription paywall to a web app / SPA using **Client-Side SDK 3.0**. Bundled npm package, no iframe, Shadow DOM rendering, built-in auth.
...
<Cards>
  ...
  <Cards.Card title="Migration from v2" href="/docs-v2/sdk-v3/migration-from-v2" description="Moving from script-tag SDK to bundled npm" />
</Cards>
