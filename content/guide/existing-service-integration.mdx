...
MONETIZE_API_URL=https://appbox.space/api/v1
```
    ...
    **Node.js/Express Setup:**
    ...
    class MonetizeClient {
      constructor(apiKey, paywallId) {
        ...
        this.baseURL = 'https://appbox.space/api/v1';
      }
    ...
    **Python/Django Setup:**
    ...
    class MonetizeClient:
        def __init__(self, api_key, paywall_id):
            ...
            self.base_url = 'https://appbox.space/api/v1'
    ...
    class MonetizeClient {
        ...
        public function __construct($apiKey, $paywallId) {
            ...
            $this->client = new Client([
                'base_uri' => 'https://appbox.space/api/v1/',
                'headers' => [
                    'x-api-key' => $this->apiKey,
                    'Content-Type' => 'application/json'
                ]
...
async function handleSubscriptionCancelled(data) {
  ...
  try {
    ...
    await localUser.update({
      ...
      cancellationDate: new Date(subscription.canceled_at),
      endedAt: subscription.ended_at ? new Date(subscription.ended_at) : null,
      cancelAtPeriodEnd: subscription.cancel_at_period_end
    });

    // Revoke access if the subscription has actually ended.
    // For end-of-period cancellation, ended_at is null until the period closes.
