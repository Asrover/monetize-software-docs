...
For testing, skip this step — connect one of our [sandbox processors](/docs-v2/payment-processor/sandbox-processors) instead and come back to your own when you're ready for real payments.

To take real payments, [create your own payment processor](/docs-v2/payment-processor/create-payment-processor).
