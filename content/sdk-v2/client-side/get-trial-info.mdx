...
<Callout type="info">
  **Regular Paywalls Only:** If you have a tokenized paywall, skip this section — it's only relevant for regular paywalls. To get remaining tokens for tokenized paywalls, use [`paywall.getUser()`](/docs-v2/sdk-v2/client-side/get-user) instead.
</Callout>
...
<Callout type="info">
  **Before Paywall Trials:** This API returns information about trials set before the paywall opens. For subscription-based trials (activated after entering card details), use [`paywall.getUser()`](/docs-v2/sdk-v2/client-side/get-user).
</Callout>
...
<Cards>
  ...
  <Cards.Card 
    title="Open Paywall" 
    href="/docs-v2/sdk-v2/client-side/open"
  />
  <Cards.Card 
