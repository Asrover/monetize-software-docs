...
- **User metadata** - custom key-value pairs set via `setUserMetadata()`
...
<Tabs items={['Authenticated Response', 'Unauthenticated Error', 'Interface Definitions']}>
  <Tabs.Tab>
    ...
    interface GetUserResponse {
      ...
      /** User metadata set via setUserMetadata(), if any */
...
<Cards>
  ...
  <Cards.Card 
    ...
    href="/docs-v2/sdk-v2/client-side/set-user-metadata"
  />
</Cards>
