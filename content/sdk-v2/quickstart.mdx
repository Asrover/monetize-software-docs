...
SDK v2 — the legacy script-tag SDK. Pick the mode that fits your stack: ready-made Client-Side UI, custom Server-Side backend, or Hybrid that combines both.

<Callout type="warning">
  **For new projects, prefer [SDK v3](/docs-v2/sdk-v3/quickstart).** v2 ships via `<script>` tag and an iframe modal — it will not pass Chrome Web Store review for new extensions and locks you into iframe-based UX. v2 stays supported for existing integrations and landings without a build step.
</Callout>

| Mode                                       | Advantages                                                                                                            | Perfect for                                                                                            |
| ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| **Client-Side SDK** — Quick start          | Single `<script>` tag, no build step; ready-made UI; built-in auth                                                    | Landing pages, legacy projects already on v2                                                            |
| **Server-Side SDK** — For custom solutions | Full control over UX; custom interfaces; complex business logic                                                       | Custom platforms; CRM/ERP integration; mobile apps                                                     |
| **Hybrid Mode** — Best of both             | Client SDK's ready UI + server-side business logic                                                                    | Custom backend integration with UI flexibility                                                         |

---

## Client-Side SDK (legacy)
...
- **Client-Side SDK:** [Full Documentation](/docs-v2/sdk-v2/client-side/install-paywall)
- **Server-Side SDK:** [API Reference](/docs-v2/sdk-v2/server-side/get-prices)
- **Hybrid Mode:** [Overview](/docs-v2/sdk-v2/hybrid/overview)
