...
<Tabs items={['JavaScript/Node.js', 'Python', 'PHP', 'cURL']}>
  ...
  <Tabs.Tab>
    ...
    url = f'https://onlineapp.pro/api/v1/paywall/{paywall_id}/get-customer-portal'
    headers = {
        'Content-Type': 'application/json',
        'x-api-key': api_key
    }
  ...
  <Tabs.Tab>
    ...
    $url = "https://onlineapp.pro/api/v1/paywall/{$paywallId}/get-customer-portal";
  ...
  <Tabs.Tab>
    ```bash
    curl -X POST https://onlineapp.pro/api/v1/paywall/123/get-customer-portal \
