...
<Tabs items={['Client mode', 'Server mode', 'Hybrid Mode']}>
  <Tabs.Tab>
  ...
  <Tabs.Tab>
    **Hybrid Mode - Best of Both Worlds**
    ...
    🔄 **Advantages:**
    - Client SDK's ready UI components
    - Server-side business logic control

    💪 **Perfect for:**
    - Custom backend integration
    - Teams wanting UI flexibility with backend control

     <Callout type="warning">
      **Requires more work:** You need to build authentication logic.
    </Callout>
