...
A custom domain is a subdomain of your website (e.g., `paywall.yoursite.com` or `api.yoursite.com`) that will be used to display the paywall. Instead of users seeing `appbox.space` in the address bar, they will see your domain.
