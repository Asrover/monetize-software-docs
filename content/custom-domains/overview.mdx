...
4. **Moderation** — moderator sets the domain to **"Verified"** (usually up to 2 business days)
...
- Moderation review: usually up to 2 business days after a successful NS check
